...
-- IMPORTANT: We must first create auth.users entries because
-- profiles.id has a foreign key to auth.users(id).
-- The on_auth_user_created trigger will auto-create profiles,
-- then we UPDATE them with rich demo data.

-- ============================================================
-- 1. CREATE AUTH USERS (6 demo users)
-- ============================================================
...
VALUES
  ('a1000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000001',
   '{"sub": "a1000000-0000-0000-0000-000000000001", "email": "rajesh.sharma@realvista.demo"}'::jsonb, 'email', NOW(), NOW(), NOW()),
  ('a1000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000002',
   '{"sub": "a1000000-0000-0000-0000-000000000002", "email": "priya.mehta@realvista.demo"}'::jsonb, 'email', NOW(), NOW(), NOW()),
  ('a1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000003',
   '{"sub": "a1000000-0000-0000-0000-000000000003", "email": "amit.patel@realvista.demo"}'::jsonb, 'email', NOW(), NOW(), NOW()),
  ('a1000000-0000-0000-0000-000000000004', 'a1000000-0000-0000-0000-000000000004', 'a1000000-0000-0000-0000-000000000004',
   '{"sub": "a1000000-0000-0000-0000-000000000004", "email": "sneha.iyer@realvista.demo"}'::jsonb, 'email', NOW(), NOW(), NOW()),
  ('a1000000-0000-0000-0000-000000000005', 'a1000000-0000-0000-0000-000000000005', 'a1000000-0000-0000-0000-000000000005',
   '{"sub": "a1000000-0000-0000-0000-000000000005", "email": "vikram.singh@realvista.demo"}'::jsonb, 'email', NOW(), NOW(), NOW()),
  ('a1000000-0000-0000-0000-000000000006', 'a1000000-0000-0000-0000-000000000006', 'a1000000-0000-0000-0000-000000000006',
   '{"sub": "a1000000-0000-0000-0000-000000000006", "email": "ananya.reddy@realvista.demo"}'::jsonb, 'email', NOW(), NOW(), NOW())
ON CONFLICT DO NOTHING;


-- ============================================================
-- 2. UPDATE PROFILES with rich demo data
-- (profiles were auto-created by the trigger above)
-- ============================================================

UPDATE profiles SET
  phone = '+91 98765 43210',
  bio = 'Senior real estate agent with 12+ years of experience in Mumbai & Pune. Specializing in luxury apartments and commercial properties. Over 500+ successful deals closed.',
  city = 'Mumbai',
...
UPDATE profiles SET
  ...
  bio = 'Passionate about helping families find their dream homes in Bangalore. Expert in residential properties, villas, and gated communities. RERA certified agent.',
  city = 'Bangalore',
...
UPDATE profiles SET
  ...
  bio = 'Property developer and builder based in Ahmedabad. Currently developing premium residential projects across Gujarat.',
  city = 'Ahmedabad',
...
UPDATE profiles SET
  ...
  bio = 'Homeowner looking to sell premium properties in Chennai and Hyderabad. All properties are well-maintained with clear documentation.',
  city = 'Chennai',
...
UPDATE profiles SET
  ...
  bio = 'IT professional looking for investment properties in NCR region. Interested in 2-3 BHK apartments with good connectivity.',
  city = 'Delhi',
...
UPDATE profiles SET
  ...
  bio = 'First-time homebuyer exploring options in Hyderabad and Bangalore. Looking for modern apartments near tech parks.',
  city = 'Hyderabad',
...
-- ============================================================
-- 3. PROPERTIES (25 realistic listings across India)
-- ============================================================
...
('b1000000-0000-0000-0000-000000000017', 'a1000000-0000-0000-0000-000000000003',
...
('b1000000-0000-0000-0000-000000000020', 'a1000000-0000-0000-0000-000000000002',
...
-- LAND PLOTS
('b1000000-0000-0000-0000-000000000023', 'a1000000-0000-0000-0000-000000000004',
...
('b1000000-0000-0000-0000-000000000024', 'a1000000-0000-0000-0000-000000000004',
...
-- RENTAL PROPERTIES
('b1000000-0000-0000-0000-000000000025', 'a1000000-0000-0000-0000-000000000002',
...
-- ============================================================
-- 4. PROPERTY IMAGES (Multiple images per property using Unsplash)
-- ============================================================

INSERT INTO property_images (property_id, image_url, is_primary, display_order) VALUES
-- Property 1: Luxury Sea-View Penthouse
('b1000000-0000-0000-0000-000000000001', 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800&h=500&fit=crop', true, 0),
('b1000000-0000-0000-0000-000000000001', 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=800&h=500&fit=crop', false, 1),
('b1000000-0000-0000-0000-000000000001', 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=800&h=500&fit=crop', false, 2),

-- Property 2: Modern 2BHK Andheri
('b1000000-0000-0000-0000-000000000002', 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=800&h=500&fit=crop', true, 0),
('b1000000-0000-0000-0000-000000000002', 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=800&h=500&fit=crop', false, 1),

-- Property 3: 3BHK Powai Rent
('b1000000-0000-0000-0000-000000000003', 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=800&h=500&fit=crop', true, 0),
('b1000000-0000-0000-0000-000000000003', 'https://images.unsplash.com/photo-1560185127-6ed189bf02f4?w=800&h=500&fit=crop', false, 1),

-- Property 4: Premium Villa Whitefield
('b1000000-0000-0000-0000-000000000004', 'https://images.unsplash.com/photo-1613490493576-7fde63acd811?w=800&h=500&fit=crop', true, 0),
('b1000000-0000-0000-0000-000000000004', 'https://images.unsplash.com/photo-1600566753086-00f18f6b0049?w=800&h=500&fit=crop', false, 1),
('b1000000-0000-0000-0000-000000000004', 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=800&h=500&fit=crop', false, 2),

-- Property 5: 1BHK Studio
('b1000000-0000-0000-0000-000000000005', 'https://images.unsplash.com/photo-1554995207-c18c203602cb?w=800&h=500&fit=crop', true, 0),

-- Property 6: 3BHK Indiranagar
('b1000000-0000-0000-0000-000000000006', 'https://images.unsplash.com/photo-1600573472592-401b489a3cdc?w=800&h=500&fit=crop', true, 0),
('b1000000-0000-0000-0000-000000000006', 'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=800&h=500&fit=crop', false, 1),

-- Property 7: 4BHK Golf Course
('b1000000-0000-0000-0000-000000000007', 'https://images.unsplash.com/photo-1600047509807-ba8f99d2cdde?w=800&h=500&fit=crop', true, 0),
('b1000000-0000-0000-0000-000000000007', 'https://images.unsplash.com/photo-1600210492493-0946911123ea?w=800&h=500&fit=crop', false, 1),

-- Property 8: 2BHK Noida
('b1000000-0000-0000-0000-000000000008', 'https://images.unsplash.com/photo-1574362848149-11496d93a7c7?w=800&h=500&fit=crop', true, 0),

-- Property 9: South Delhi Floor
('b1000000-0000-0000-0000-000000000009', 'https://images.unsplash.com/photo-1600585153490-76fb20a32601?w=800&h=500&fit=crop', true, 0),
('b1000000-0000-0000-0000-000000000009', 'https://images.unsplash.com/photo-1600566752355-35792bedcfea?w=800&h=500&fit=crop', false, 1),

-- Property 10: Studio Cyber City
('b1000000-0000-0000-0000-000000000010', 'https://images.unsplash.com/photo-1536376072261-38c75010e6c9?w=800&h=500&fit=crop', true, 0),

-- Property 11: Villa Gachibowli
('b1000000-0000-0000-0000-000000000011', 'https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=800&h=500&fit=crop', true, 0),
('b1000000-0000-0000-0000-000000000011', 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800&h=500&fit=crop', false, 1),
('b1000000-0000-0000-0000-000000000011', 'https://images.unsplash.com/photo-1600607687644-aac4c3eac7f4?w=800&h=500&fit=crop', false, 2),

-- Property 12: 2BHK HITEC City
('b1000000-0000-0000-0000-000000000012', 'https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?w=800&h=500&fit=crop', true, 0),

-- Property 13: Heritage Bungalow
('b1000000-0000-0000-0000-000000000013', 'https://images.unsplash.com/photo-1600047509358-9dc75507daeb?w=800&h=500&fit=crop', true, 0),
('b1000000-0000-0000-0000-000000000013', 'https://images.unsplash.com/photo-1600566753376-12c8ab7fb75b?w=800&h=500&fit=crop', false, 1),

-- Property 14: ECR Chennai
('b1000000-0000-0000-0000-000000000014', 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=800&h=500&fit=crop', true, 0),

-- Property 15: Lavasa Villa
('b1000000-0000-0000-0000-000000000015', 'https://images.unsplash.com/photo-1600585154363-67eb9e2e2099?w=800&h=500&fit=crop', true, 0),

-- Property 16: 2BHK Hinjewadi
('b1000000-0000-0000-0000-000000000016', 'https://images.unsplash.com/photo-1493809842364-78817add7ffb?w=800&h=500&fit=crop', true, 0),

-- Property 17: Penthouse SG Highway
('b1000000-0000-0000-0000-000000000017', 'https://images.unsplash.com/photo-1600607688969-a5bfcd646154?w=800&h=500&fit=crop', true, 0),
('b1000000-0000-0000-0000-000000000017', 'https://images.unsplash.com/photo-1600566752447-f4e219dcc6ff?w=800&h=500&fit=crop', false, 1),

-- Property 18: Commercial CG Road
('b1000000-0000-0000-0000-000000000018', 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=800&h=500&fit=crop', true, 0),

-- Property 19: Royal Haveli Jaipur
('b1000000-0000-0000-0000-000000000019', 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=800&h=500&fit=crop', true, 0),
('b1000000-0000-0000-0000-000000000019', 'https://images.unsplash.com/photo-1613490493576-7fde63acd811?w=800&h=500&fit=crop', false, 1),

-- Property 20: Budget 1BHK Jaipur
('b1000000-0000-0000-0000-000000000020', 'https://images.unsplash.com/photo-1560185893-a55cbc8c57e8?w=800&h=500&fit=crop', true, 0),

-- Property 21: Riverside Kolkata
('b1000000-0000-0000-0000-000000000021', 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=800&h=500&fit=crop', true, 0),

-- Property 22: 3BHK Surat
('b1000000-0000-0000-0000-000000000022', 'https://images.unsplash.com/photo-1600210491892-03d54c0aaf87?w=800&h=500&fit=crop', true, 0),

-- Property 23: Plot Whitefield
('b1000000-0000-0000-0000-000000000023', 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&h=500&fit=crop', true, 0),

-- Property 24: Farmland
('b1000000-0000-0000-0000-000000000024', 'https://images.unsplash.com/photo-1500076656116-558758c991c1?w=800&h=500&fit=crop', true, 0),

-- Property 25: Furnished 2BHK Koramangala
('b1000000-0000-0000-0000-000000000025', 'https://images.unsplash.com/photo-1600585152220-90363fe7e115?w=800&h=500&fit=crop', true, 0),
('b1000000-0000-0000-0000-000000000025', 'https://images.unsplash.com/photo-1600573472592-401b489a3cdc?w=800&h=500&fit=crop', false, 1)
...
INSERT INTO favorites (user_id, property_id) VALUES
  ...
  ('a1000000-0000-0000-0000-000000000006', 'b1000000-0000-0000-0000-000000000005'),
  ('a1000000-0000-0000-0000-000000000006', 'b1000000-0000-0000-0000-000000000012'),
  ('a1000000-0000-0000-0000-000000000006', 'b1000000-0000-0000-0000-000000000006'),
  ('a1000000-0000-0000-0000-000000000006', 'b1000000-0000-0000-0000-000000000025')
ON CONFLICT DO NOTHING;
